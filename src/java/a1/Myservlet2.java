...
public class Myservlet2 extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        out.println(a1+a2+a3+a4+a5+a6+a7+a8+a9+a10);
//        try 
//        {
//          Class.forName("oracle.jdbc.driver.OracleDriver");
//          Connection cn =  DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","tiger");
//          Statement st = cn.createStatement();
//          PreparedStatement pst = cn.prepareStatement("insert into studentform1 values(?,?,?,?,?,?,?,?,?,?)");
//          
//          pst.setString(1,a1);
//          pst.setString(2,a2);
//          pst.setString(3,a3);
...
//          if(i>0)
//          {
//              out.println("<html> <body align='center'> <h1> Student details entered successfully.Please wait while we upload the student details and update our database.</h1></body> </html>");
//              response.setHeader("Refresh", "2;url=StudentLogin.html");
//          }
//          else
//          {
